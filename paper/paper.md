...
Amin Alibakhshi has utilized Claude Opus 4.6 for code debugging and improving the Julia syntax of some parts of the code.

After using this tool, he carefully reviewed and edited them to ensure accuracy and take full responsibility for the content of the published article.
# References