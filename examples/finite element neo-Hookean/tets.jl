...
#     input.displacement = -strainApplied * sampleSize
# end
input.ΓN = getfacetset(grid, "top")
input.facetsets = [input.ΓN]
input.traction = [0.0, 0.0, 0.8]
...
maxIterPerInc,totalTime,initInc,minInc,maxInc,totalInc = initialize_solver(500,1.0,1e-1,1e-6,0.1,1000)
